...
class Visite extends Model
{
  ...
  public $with = ['nourrissement', 'traitement', 'mort', 'poseHausses', "recolteMiel", 'recoltePropolis', "recoltePollen", "recolteGeleeRoyale", "pesee", "comptage", "controle", "nettoyagePlancher", "renouvellementCire", "division", "poseElements", "transvasement", "transvasement", "reunion", "introduction"];
